...
class TestJarvisModel(unittest.TestCase):
    ...
    def test_preprocess_data(self):
        # Create a test dataset with numerical and categorical features,
    ...
    def test_predict(self):
        ...
        features_preprocessed = self.jarvis.preprocess_data(
            raw_data_predict, fit_preprocessor=False)[0]
